...
namespace Oodles
{
	...
	public class Utility
	{
            ...
            get
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        string[] nameInfo = userName.Split(new char[] { '\\' }, 2);
        ...
        public static Color ColorPercentage(Color original, Color changeTo, float percentage)
        {
            float A_diff = changeTo.A - original.A;
            float R_diff = changeTo.R - original.R;
            float G_diff = changeTo.G - original.G;
            float B_diff = changeTo.B - original.B;

            return Color.FromArgb(
            (int)(changeTo.A - (A_diff * percentage)),
            (int)(changeTo.R - (R_diff * percentage)),
            (int)(changeTo.G - (G_diff * percentage)),
            (int)(changeTo.B - (B_diff * percentage)));
        }
